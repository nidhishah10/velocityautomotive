<?php
/**
 * Template Name: Video Custom Page
 */
...
if ($arr_posts->have_posts()):
	...
	while ($arr_posts->have_posts()):
		...
		?>
																								...
																								<img
																								    src="https://s-media-cache-ak0.pinimg.com/736x/00/37/03/0037037f1590875493f413c1fdbd52b1--cool-beards-inspiring-photography.jpg" />
		...
		?></p>
																								    <a href="<?php the_permalink();?>" class="button">Read
																								        More</a>
																								</div>
																								</article>
